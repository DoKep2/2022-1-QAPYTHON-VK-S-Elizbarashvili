...
def get_data_locator_by_action_and_id(action, _id):
    return By.XPATH, f"//div[contains(@data-test, '{action}-{_id}')]"
...
class LogInModalPanelLocators:
    ...
    NOTIFY_ERROR_MODULE = (By.XPATH, "//div[contains(@class, 'notify-module-error')]")
